...
const navItems = [
  ...
  { label: 'Cowork',    labelAr: 'كوورك',            icon: 'smart_toy',     path: '/cowork' },
  { label: 'Website',   labelAr: 'الموقع',           icon: 'language',      path: '/website' },
  ...
  { label: 'Automation',labelAr: 'الأتمتة',          icon: 'smart_toy',     path: '/automation' },
